...
-- VIEW criada pelo Activesoft Service Pack em 19/06/2018 durante atualização para versão 1.064.750.
--


CREATE VIEW dbo.VwSituacaoAlunoDisciplina_Auditoria AS
