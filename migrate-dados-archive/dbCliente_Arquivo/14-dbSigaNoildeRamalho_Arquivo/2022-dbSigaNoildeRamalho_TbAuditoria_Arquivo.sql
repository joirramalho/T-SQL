-- SELECT  COUNT(*) FROM dbSigaNoildeRamalho_Arquivo.dbo.TbAuditoria;

SELECT	YEAR(DataHORA),   COUNT(*) FROM dbSigaNoildeRamalho.dbo.TbAuditoria GROUP BY YEAR(DataHORA);

    -- CREATE DATABASE dbSigaNoildeRamalho_Arquivo

    -- DROP TABLE dbSigaNoildeRamalho_Arquivo.dbo.TbAuditoria

-- SELECT  TOP 100 * FROM dbSigaNoildeRamalho_Arquivo02.dbo.TbAuditoria


USE dbSigaNoildeRamalho_Arquivo;

-- CRIA TABELA DESTINO
	--SELECT * INTO dbSigaNoildeRamalho_Arquivo.dbo.TbAuditoria
	--    FROM dbSigaNoildeRamalho.dbo.TbAuditoria WHERE YEAR(DAtaHora) = 2015
...
SET IDENTITY_INSERT dbSigaNoildeRamalho_Arquivo.dbo.TbAuditoria ON;

INSERT INTO dbSigaNoildeRamalho_Arquivo.dbo.TbAuditoria ( Tabela, IdUsuario, Operacao, DataHora, ValorChave1, ValorChave2, ValorChave3, ValorChave4, ValorChave5, DescricaoOperacao, IdAuditoria )
        SELECT Tabela, IdUsuario, Operacao, DataHora, ValorChave1, ValorChave2, ValorChave3, ValorChave4, ValorChave5, DescricaoOperacao, IdAuditoria
            FROM dbSigaNoildeRamalho.dbo.TbAuditoria WHERE YEAR(DAtaHora) <= 2022

            
        

SELECT	YEAR(DataHORA),   COUNT(*) FROM dbSigaNoildeRamalho.dbo.TbAuditoria 			GROUP BY YEAR(DataHORA) ORDER BY YEAR(DataHORA);
SELECT	YEAR(DataHORA),   COUNT(*) FROM dbSigaNoildeRamalho_Arquivo.dbo.TbAuditoria 	GROUP BY YEAR(DataHORA) ORDER BY YEAR(DataHORA);
...
BEGIN
	...
	FROM dbSigaNoildeRamalho.dbo.TbAuditoria
