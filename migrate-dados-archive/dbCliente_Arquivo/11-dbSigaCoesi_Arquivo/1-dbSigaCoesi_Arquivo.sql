...
--ALTER DATABASE dbSigaCoesi_Arquivo COLLATE SQL_Latin1_General_CP1_CI_AI

--ALTER DATABASE [dbSigaCoesi_Arquivo] SET RECOVERY SIMPLE WITH NO_WAIT;
...
CREATE USER [userCoesi] FOR LOGIN [userCoesi];
...
EXEC sp_AddRoleMember 'db_datareader', 'userCoesi'
