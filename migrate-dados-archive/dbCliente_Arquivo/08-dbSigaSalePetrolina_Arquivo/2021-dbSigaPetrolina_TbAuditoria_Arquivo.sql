-- SELECT  COUNT(*) FROM dbSigaSalePetrolina_Arquivo03.dbo.TbAuditoria; -- 2812610

-- SELECT  COUNT(*) FROM dbSigaSalePetrolina_Arquivo02.dbo.TbAuditoria; -- 1133087
-- SELECT  COUNT(*) FROM dbSigaSalePetrolina_Arquivo01.dbo.TbAuditoria; -- 1763480 2896567
-- SELECT  COUNT(*) FROM dbSigaSalePetrolina_Arquivo.dbo.TbAuditoria;

SELECT	YEAR(DataHORA),   COUNT(*) FROM dbSigaSalePetrolina.dbo.TbAuditoria GROUP BY YEAR(DataHORA);

    -- CREATE DATABASE dbSigaSalePetrolina_Arquivo

    -- DROP TABLE dbSigaSalePetrolina_Arquivo.dbo.TbAuditoria

-- SELECT  TOP 100 * FROM dbSigaSalePetrolina_Arquivo02.dbo.TbAuditoria


USE dbSigaSalePetrolina_Arquivo;

-- CRIA TABELA DESTINO
	--SELECT * INTO dbSigaSalePetrolina_Arquivo.dbo.TbAuditoria
	--    FROM dbSigaSalePetrolina.dbo.TbAuditoria WHERE YEAR(DAtaHora) = 2015
...
SET IDENTITY_INSERT dbSigaSalePetrolina_Arquivo.dbo.TbAuditoria ON;

INSERT INTO dbSigaSalePetrolina_Arquivo.dbo.TbAuditoria ( Tabela, IdUsuario, Operacao, DataHora, ValorChave1, ValorChave2, ValorChave3, ValorChave4, ValorChave5, DescricaoOperacao, IdAuditoria )
...
-- dbSigaSalePetrolina RETOMAR AQUI
SET IDENTITY_INSERT dbSigaSalePetrolina_Arquivo.dbo.TbAuditoria ON;

INSERT INTO dbSigaSalePetrolina_Arquivo.dbo.TbAuditoria ( Tabela, IdUsuario, Operacao, DataHora, ValorChave1, ValorChave2, ValorChave3, ValorChave4, ValorChave5, DescricaoOperacao, IdAuditoria )
        SELECT Tabela, IdUsuario, Operacao, DataHora, ValorChave1, ValorChave2, ValorChave3, ValorChave4, ValorChave5, DescricaoOperacao, IdAuditoria
            FROM dbSigaSalePetrolina.dbo.TbAuditoria WHERE YEAR(DAtaHora) <= 2021

            
        

SELECT	YEAR(DataHORA),   COUNT(*) FROM dbSigaSalePetrolina.dbo.TbAuditoria 			GROUP BY YEAR(DataHORA);
SELECT	YEAR(DataHORA),   COUNT(*) FROM dbSigaSalePetrolina_Arquivo.dbo.TbAuditoria 	GROUP BY YEAR(DataHORA);
...
BEGIN
	...
	FROM dbSigaSalePetrolina.dbo.TbAuditoria
