...
--ALTER DATABASE dbSigaSaleMazzarello_Arquivo COLLATE SQL_Latin1_General_CP1_CI_AI

--ALTER DATABASE [dbSigaSaleMazzarello_Arquivo] SET RECOVERY SIMPLE WITH NO_WAIT;
...
CREATE USER [userSaleMazzarello] FOR LOGIN [userSaleMazzarello];
...
EXEC sp_AddRoleMember 'db_datareader', 'userSaleMazzarello'
