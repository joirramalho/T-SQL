...
ALTER TABLE [dbo].[TbFavorecido] WITH CHECK ADD  CONSTRAINT [FK_TbFavorecido_TbUnidade] FOREIGN KEY([IdUnidade]) REFERENCES [dbo].[TbUnidade] ([IdUnidade])                                                                                                      
GO
ALTER TABLE [dbo].[TbFavorecido] CHECK CONSTRAINT [FK_TbFavorecido_TbUnidade]
GO

ALTER TABLE [dbo].[TbFeriado] WITH CHECK ADD  CONSTRAINT [FK_TbFeriado_TbUnidade] FOREIGN KEY([IdUnidade]) REFERENCES [dbo].[TbUnidade] ([IdUnidade])                                                                                                            
GO
ALTER TABLE [dbo].[TbFeriado] CHECK CONSTRAINT [FK_TbFeriado_TbUnidade]
GO

ALTER TABLE [dbo].[TbFormula] WITH CHECK ADD  CONSTRAINT [FK_TbFormula_TbUnidade] FOREIGN KEY([IdUnidade]) REFERENCES [dbo].[TbUnidade] ([IdUnidade])                                                                                                            
GO
ALTER TABLE [dbo].[TbFormula] CHECK CONSTRAINT [FK_TbFormula_TbUnidade]
GO

ALTER TABLE [dbo].[TbInformativo] WITH CHECK ADD  CONSTRAINT [FK_TbInformativo_TbUnidade] FOREIGN KEY([IdUnidade]) REFERENCES [dbo].[TbUnidade] ([IdUnidade])                                                                                                    
GO
ALTER TABLE [dbo].[TbInformativo] CHECK CONSTRAINT [FK_TbInformativo_TbUnidade]
GO

ALTER TABLE [dbo].[TbNotaConceito] WITH CHECK ADD  CONSTRAINT [FK_TbNotaConceito_TbUnidade] FOREIGN KEY([IdUnidade]) REFERENCES [dbo].[TbUnidade] ([IdUnidade])                                                                                                  
GO
ALTER TABLE [dbo].[TbNotaConceito] CHECK CONSTRAINT [FK_TbNotaConceito_TbUnidade]
GO

ALTER TABLE [dbo].[TbParcelaCobranca] WITH CHECK ADD  CONSTRAINT [FK_TbParcelaCobranca_TbUnidade] FOREIGN KEY([IdUnidade]) REFERENCES [dbo].[TbUnidade] ([IdUnidade])                                                                                            
GO
ALTER TABLE [dbo].[TbParcelaCobranca] CHECK CONSTRAINT [FK_TbParcelaCobranca_TbUnidade]
GO

ALTER TABLE [dbo].[TbPlanoContas] WITH CHECK ADD  CONSTRAINT [FK_TbPlanoContas_TbUnidade] FOREIGN KEY([IdUnidade]) REFERENCES [dbo].[TbUnidade] ([IdUnidade])                                                                                                    
GO
