-- RENOMEAR A TABELA _TbLancamentoCobranca_AjusteNFSe_20211030 com *** Replace All ***
...
INTO	_TbLancamentoCobranca_AjusteNFSe_20211030
FROM	VwTituloCobrancaDescricao tc
WHERE	IdTituloCobranca IN ( 66398, 66399, 66400 )
ORDER	BY IdTituloCobranca 


SELECT	* 
FROM	_TbLancamentoCobranca_AjusteNFSe_20211030
...
WHERE	IdTituloCobrancaGerado IN ( SELECT IdTituloCobranca FROM _TbLancamentoCobranca_AjusteNFSe_20211030 )
