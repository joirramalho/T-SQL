--28dez21
--Check Monthly Growth of Database
--https://www.mssqltips.com/sqlservertip/6158/how-to-check-monthly-growth-of-database-in-sql-server/

--https://www.mssqltips.com/sqlservertip/2639/sql-server-lead-and-lag-functions/
...
SELECT TOP 1000
    ...
    , [day] = DATEPART(dd,[backup_start_date])    
...
FROM 
    msdb.dbo.backupset
WHERE 
    [database_name] = N'dbCrmActivesoft'
AND [type] = 'D'
