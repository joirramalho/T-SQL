...
--ONLINE
	...
	--ALTER DATABASE dbSigaMajoris SET OFFLINE;
...
--READ_WRITE & READ_ONLY
	--ALTER DATABASE dbBibModuloAracaju    SET  READ_WRITE WITH NO_WAIT
...
--SET RECOVERY
	...
	--ALTER DATABASE [dbBibModuloAracaju] SET RECOVERY FULL WITH NO_WAIT
