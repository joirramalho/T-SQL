...
-- 	UNION ALL
-- 	SELECT	*
-- 	FROM	dbSigaSalesianoDomBosco_Arquivo01.dbo.TbFaseNotaAluno_Auditoria
-- 	UNION ALL
-- 	SELECT	*
-- 	FROM	dbSigaSalesianoDomBosco_Arquivo02.dbo.TbFaseNotaAluno_Auditoria
-- 	UNION ALL
-- 	SELECT	*
-- 	FROM	dbSigaSalesianoDomBosco_Arquivo03.dbo.TbFaseNotaAluno_Auditoria;