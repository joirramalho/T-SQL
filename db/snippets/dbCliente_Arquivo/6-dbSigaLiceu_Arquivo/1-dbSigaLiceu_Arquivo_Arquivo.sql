...
--ALTER DATABASE dbSigaLiceu_Arquivo COLLATE SQL_Latin1_General_CP1_CI_AI

--ALTER DATABASE [dbSigaLiceu_Arquivo] SET RECOVERY SIMPLE WITH NO_WAIT;
...
CREATE USER [userSaleLiceu] FOR LOGIN [userSaleDomBosco];
...
EXEC sp_AddRoleMember 'db_datareader', 'userSaleLiceu'
