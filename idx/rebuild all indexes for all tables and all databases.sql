-- 03ago21 -- dbCrmActivesoft

-- rebuild all indexes for all tables and all databases -- 31Out20
...
WHERE name IN ('dbCrmActivesoft', '243400') -- use this to select specific databases and comment out line above
