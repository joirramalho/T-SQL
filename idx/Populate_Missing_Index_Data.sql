...
*/
		...
		---
		--VERSAO 2 - TOP 50 Improvement_Measure
		--17JUN22
		/*
		ALTER PROCEDURE dbo.Populate_Missing_Index_Data
			@Retention_Period_for_Detail_Data_Days SMALLINT = 30,
			@Delete_All_Summary_Data BIT = 0
		AS
		BEGIN
			...
			WHERE dm_db_missing_index_group_stats.Last_User_Seek > @Last_Seek_Time
				...
				ORDER BY ( Avg_Total_User_Cost * (Avg_User_Impact / 100.0) * User_Seeks ) DESC --AS Improvement_Measure;
