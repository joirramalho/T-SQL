...
EXEC dbLogMonitor.dbo.sp_foreachdb N'
    ...
    IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS	WHERE TABLE_NAME = ''VwLancamentoCobrancaContabil'' AND column_name like ''ValorDescontoNaoCondicionadoPROUNI'' )
        BEGIN
            PRINT DB_NAME()  
        END
--	 ELSE
