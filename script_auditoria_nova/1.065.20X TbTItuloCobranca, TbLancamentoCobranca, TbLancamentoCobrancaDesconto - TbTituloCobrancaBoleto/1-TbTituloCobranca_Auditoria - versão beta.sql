...
-- POPULAR TABELA ESPELHO com dados da tabela base (Operação "+" APENAS SE *** NÃO *** EXISTIA TABELA ESPELHADA -------------------------------------------
...
SELECT 	IdTituloCobrancaAuditoria, IdTituloCobranca , PRIOR_IdTituloCobrancaAuditoria
	...
	SET Comentario = 'A negociação 1183', StEmailEnviado = 0, IdFormaRecebimento = 5
